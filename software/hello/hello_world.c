...
void setDDSFre()
{
	...
	if (FInfo.divideFre <= 200000 && FInfo.divideFre > 20000) {
		FInfo.divideFre = FInfo.divideFre - 2000;
	}
	else if (FInfo.divideFre <= 20000 && FInfo.divideFre > 2000) {
		FInfo.divideFre = FInfo.divideFre - 200;
	}
	else if (FInfo.divideFre <= 2000 && FInfo.divideFre > 200) {
		FInfo.divideFre = FInfo.divideFre - 20;
	}
	else if (FInfo.divideFre <= 200 && FInfo.divideFre > 20) {
		FInfo.divideFre = FInfo.divideFre - 2;
	}
	else if (FInfo.divideFre <= 20 && FInfo.divideFre > 2) {
		FInfo.divideFre = FInfo.divideFre - 1;
	}

	FInfo.CurFre = 3125000 / (float)FInfo.divideFre;
...
////	pFile = fopen("D:\intelFPGAFiles\ALL\data.txt", "a");
